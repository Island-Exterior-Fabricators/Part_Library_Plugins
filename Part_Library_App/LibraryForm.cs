...
namespace Part_Library_App
{
    public partial class LibraryForm : MaterialForm
    {
        ...
        public LibraryForm()
        {
            ExcelHelper.SetDictionary();

            //https://islandcompanies.sharepoint.com/:x:/r/sites/PartLibrary/Shared%20Documents/181128%20-%20Extrusion%20Library%20(Working%20File).xlsm?d=wd6dbf2af9eac4627863d096af93f1a13&csf=1&web=1&e=J3Ah7U
            ...
            SharepointHelper.SharepointPull(xlFileLink, out parts);
        ...
        private void SeedListViewW(Dictionary<string, List<PartTypes.Part>> parts)
        {
            ...
            List<string> headers = new List<string>() { "ID", "Part Description", "Project First Used On", "Function", "Type",
            "Keymark", "Sapa", "International Extrusions", "Alloy", "Temper", "Finish", "Hyperlink"};
            string longest = "";
